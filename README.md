...
This is a learning/demo project and intentionally keeps the scope small. The code includes basic validation to reduce risk from malformed file names and unsafe paths, but it is not intended to replace production-grade file-transfer systems or hardened network applications.

## Potential Improvements

- Add authentication and authorization
- Support encrypted transmission using TLS
- Add file size limits and quotas
- Use a database for metadata tracking
- Add a web dashboard or API layer
- Improve error handling and logging

## Portfolio Summary

This project demonstrates practical Python networking fundamentals in a small but complete application. It showcases the ability to design and implement a working client/server system, manage file transfers over TCP, and build software that is understandable, extensible, and suitable as a technical portfolio example.
